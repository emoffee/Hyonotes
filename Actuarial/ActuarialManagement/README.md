...
5. 在内部，偿付能力是如何被管理的？
保险公司使用各种不同的办法对偿付能力资本进行管理。大致上分两种：增加资本和降低公司的负债。
  * 股权资本，即股东注入新的资本。
  * 次级债。公司对次级债本息的偿还责任一般在其对饱饭吃有人的给付责任之后，因此，在公司破产清算时，目前未清偿的次级债务责任一般不影响保单持有人的权益。这些特征使得次级债具备资本属性，许多国家的监管机构在评估保险公司偿付能力按照一定的标准将次级债认可为附属资本。
  * 财务再保险
  * 资产证券化
    * 从技术上说，就是让缺乏流动性的金融资产进行集合，以此为支持发行证券。
    * 从理论上说，只要可以对资产的未来现金流进行合理估计，就可对这些资产进行证券化。
    * 从效果上说，通过证券化，可以把一些不受监管或会计准则认可的资产转化为认可资产，从而更有效的对其法定偿付能力资本进行管理。
  * 衍生品
  * 其他措施
    * 出售非认可资本
    * 降低负债评估基础的谨慎程度
    ...
    * 改变产品结构
6. 在外部，偿付能力是如何被监管的？
主要是建立量化指标体系和偿付能力管理组织架构这两个方面：
  * 量化指标体系
    * 偿付能力额度监管
    * 分类监管： 分项监管指标
    * 动态偿付能力测试
      * 寿险公司和产险公司应对全部保险业务进行测试。
      * 测试场景
        * 基本场景： 保险公司未来最有可能发生的情景
        * 不利场景
          * 必测不利场景
          * 自测不利场景
    * 准备金充足性测试：保险公司在基本情景及各种乐观和悲观情境下通过对未来现金流预测得出当前评估点的毛保费准备金，然后和公司实际提取的法定准备金进行比较，来判断准备金提取是否充足。
  * 偿付能力管理组织架构
